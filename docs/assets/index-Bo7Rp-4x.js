...
const _imports_1 = "/live2d-microphone/assets/default-CG1yBBB1.png";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1$2, [
        ...
        _cache[2] || (_cache[2] = createBaseVNode("span", { class: "name" }, "客服MM", -1)),
        createBaseVNode("span", _hoisted_2$1, [
          createBaseVNode("i", {
            class: normalizeClass(["fa", vociceOpen.value ? "fa-volume-up" : "fa-volume-down"]),
            "aria-hidden": "true",
            onClick: _cache[0] || (_cache[0] = ($event) => vociceOpen.value = vociceOpen.value ? false : true)
          }, null, 2)
        ])
      ]);
    };
...
Object.assign(WaveFileLoader.prototype, {
  ...
  exportWAV16k(data) {
    ...
    file.setInt32(4, data.byteLength + 36, true);
...
(45-${this.header.dataChunkSize + 44})数据区...`;
  ...
  extractData: function(data, BitsPerSample, numChannels, tupleSize) {
    if (BitsPerSample === void 0) BitsPerSample = this.header.bitsPerSample;
    if (BitsPerSample !== 16) throw "support 16bitFloat only, the BitsPerSample is " + BitsPerSample;
    if (numChannels === void 0) numChannels = this.header.channelCount;
    if (tupleSize === void 0) tupleSize = BitsPerSample * numChannels / 8;
    ...
    while (offset < dataView.byteLength) {
      for (let i = 0; i < numChannels; i++) {
        buffer[i][offset / tupleSize] = dataView.getInt16(offset + i * 2, true) < 0 ? dataView.getInt16(offset + i * 2, true) / 32768 : dataView.getInt16(offset + i * 2, true) / 32767;
      }
      offset += tupleSize;
    }
    return buffer;
...
var freeGlobal = typeof define_global_default$1 == "object" && define_global_default$1 && define_global_default$1.Object === Object && define_global_default$1;
...
const _global = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof define_global_default !== "undefined" ? define_global_default : typeof self !== "undefined" ? self : {};
...
const _sfc_main$3 = {
  ...
  methods: {
    cssAnim(dom, animName, duration, timing, delay) {
      ...
      dom.addEventListener(DEFINES$1.ANIM_END, function(ev) {
        if (ev.target === this) {
    ...
    initValue(dom, stroke, fill, cx, cy, r, storokeWidth, btnAnimName, type) {
      ...
      dom.addEventListener(DEFINES$1.TOUCH_CLICK, () => {
        this.$emit("clickFromChild");
        this.cssAnim(dom, btnAnimName, DEFINES$1.ANIM_DURATION / 3, DEFINES$1.ANIM_EASING);
      });
    }
  }
};
const DEFINES = _sfc_main$3.data().defines;
const _sfc_main$2 = {
  name: "Live2DView",
  data() {
    return {
  ...
  methods: {
    init(container) {
      ...
      this.create_Live2D(
        DEFINES.MODEL_ASUNA_PATH,
        DEFINES.MODEL_ASUNA_JSON,
        DEFINES.ASUNA_OTHER_SCALE,
        DEFINES.ASUNA_OTHER_POSX,
        DEFINES.ASUNA_OTHER_POSY
      );
    },
...
const _hoisted_1 = {
  ...
  class: "glcanvas",
  ref: "glcanvas",
  style: { "display": "block", "width": "100%", "height": "95%" }
};
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("canvas", _hoisted_1, null, 512);
}
const live2d = /* @__PURE__ */ _export_sfc$1(_sfc_main$2, [["render", _sfc_render], ["__scopeId", "data-v-d438f278"]]);
const _sfc_main$1 = {
  __name: "index",
  setup(__props) {
    ...
    onMounted(() => {
      live2dRef.value.init(containerRef.value);
    });
    return (_ctx, _cache) => {
